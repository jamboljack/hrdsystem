					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								?>
								<span class="caption-subject font-blue-sharp bold uppercase">Employee List Preview - <?php echo $title.' '.$this->input->post('tgl1').' s/d '.$this->input->post('tgl2'); ?></span>
							</div>							
							<div class="tools">
							</div>
						</div>
						...
						<div class="portlet-body">							
							...
							foreach($daftardepartment as $d) {								
								...
								if ($OptBy == 'startjoin') {
									$cek_dept 		= $this->listemployee_model->select_check_department_join($department_id)->result();
								} elseif ($OptBy == 'startcontract') {
									$cek_dept 		= $this->listemployee_model->select_check_department_start($department_id)->result();
								} elseif ($OptBy == 'endcontract') {
									$cek_dept 		= $this->listemployee_model->select_check_department_end($department_id)->result();
								}
