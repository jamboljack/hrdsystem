					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-blue-sharp bold uppercase">Employee List Preview - <?php echo $detail->department_name; ?></span>
							</div>							
							<div class="tools">
							</div>
						</div>
						<a href="<?php echo site_url('report/listemployee/'); ?>/print_report/<?php echo $Report['Dept']; ?>" class="btn btn-primary" target="_blank"><span class="glyphicon glyphicon-print"></span> Print Preview</a>
						<a href="<?php echo site_url('report/listemployee/'); ?>/print_report_pdf/<?php echo $Report['Dept']; ?>" class="btn btn-danger" target="_blank"><span class="glyphicon glyphicon-download-alt"></span> PDF</a>
