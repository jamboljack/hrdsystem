				...
				<div class="col-md-12">																	
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-book"></i> Report List of Employee Status
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">							
							<form action="<?php echo site_url('report/listemployeestatus/preview'); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
