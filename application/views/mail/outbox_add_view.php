				...
				<div class="col-md-12">																	
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus-circle"></i>Form Add Outbox Mail
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">						
							<form action="<?php echo site_url('mail/outbox/savedata'); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
