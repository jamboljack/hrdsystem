				...
				<div class="col-md-12">																	
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus-circle"></i>Form Add Memo
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">						
							<form action="<?php echo site_url('mail/memo/savedata'); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
								...
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-5 has-error">
											<input type="text" class="form-control" placeholder="Enter Memo No." name="memo_no" value="<?php echo set_value('memo_no'); ?>" autocomplete="off" required autofocus />
											<?php echo form_error('memo_no', '<span class="help-block has-error">','</span>'); ?>									
										</div>
									</div>
									<div class="form-group">
