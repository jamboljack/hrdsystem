...
<script>
    function hapusData(inbox_id) {
        ...
        swal({
            ...
            window.location.href="<?php echo site_url('mail/inbox/deletedata'); ?>"+"/"+id
        });
    }
</script>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-blue-sharp bold uppercase">Inbox Mail List</span>
							</div>							
							<div class="tools">
							</div>
						</div>
						<a href="<?php echo site_url('mail/inbox/adddata'); ?>">
