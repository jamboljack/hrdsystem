	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="<?php echo site_url('mail/outbox'); ?>">Outbox Mail</a>
					<i class="fa fa-circle"></i>
				</li>
				<li class="active">
					 Edit Outbox Mail
				...
				<div class="col-md-12">																	
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus-circle"></i>Form Edit Outbox Mail
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">						
							<form action="<?php echo site_url('mail/outbox/updatedata'); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
							<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
							<input type="hidden" name="id" value="<?php echo $detail->outbox_id; ?>" />
								...
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-5 has-error">
											<input type="text" class="form-control" placeholder="Enter Mail No." name="mail_no" value="<?php echo $detail->outbox_no; ?>" autocomplete="off" required>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Title</label>
										<div class="col-md-9 has-error">
											<input type="text" class="form-control" placeholder="Enter Title" name="title" value="<?php echo $detail->outbox_title; ?>" autocomplete="off" required>
										</div>
									</div>
									<?php
			                        $tanggal 	= $detail->outbox_date; 
									...
									<div class="form-group">
										...
										<div class="col-md-9 has-error">											
											<textarea class="form-control ckeditor" name="desc" rows="6"><?php echo $detail->outbox_desc; ?></textarea>
										</div>										
									</div>									
								</div>
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<a href="<?php echo site_url('mail/outbox'); ?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left"></span> Cancel</a>
										</div>
									</div>
								</div>
							</form>
