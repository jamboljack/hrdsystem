				...
				<div class="col-md-12">																	
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Form Add Blood
							</div>
							<div class="tools">
						...
						<!-- BEGIN FORM-->
						<form action="<?php echo site_url('blood/savedata'); ?>" class="form-horizontal" method="post">
							...
							<div class="form-body">								
								<div class="form-group">
									...
									<div class="col-md-8 has-error">
										<input type="text" class="form-control" placeholder="Enter Blood Name" name="name" value="<?php echo set_value('name'); ?>" autocomplete="off" required autofocus>
