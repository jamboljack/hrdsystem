	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="<?php echo site_url('rew-pun/transaction_reward'); ?>">Transaction Reward</a>
					<i class="fa fa-circle"></i>
				</li>
				<li class="active">
					 Add Transaction Reward
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
				...
				<div class="col-md-12">																	
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus-circle"></i>Form Add Transaction Reward
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">						
							<form action="<?php echo site_url('rew-pun/transaction_reward/savedata'); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
								...
								<div class="form-body">									
									...
									<div class="form-group">
										...
										<div class="col-md-5 has-error">
											<input type="text" class="form-control" placeholder="Enter Reward No." name="reward_no" value="<?php echo set_value('reward_no'); ?>" autocomplete="off" required>
											<?php echo form_error('reward_no', '<span class="help-block has-error">','</span>'); ?>									
										</div>
									</div>
									<div class="form-group">
										...
										<?php echo form_error('lstReward', '<span class="help-block has-error">','</span>'); ?>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-9 has-error">
											<input class="form-control form-control-inline input-medium date-picker" size="16" type="text" name="date_reward" value="<?php echo set_value('date_reward'); ?>" placeholder="DD-MM-YYYY" autocomplete="off" required />
											<?php echo form_error('date_reward', '<span class="help-block has-error">','</span>'); ?>
										</div>
									</div>
									<div class="form-group">
