				...
				<div class="col-md-12">																	
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>Form Edit Transaction Punishment
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">						
							<form action="<?php echo site_url('rew-pun/transaction_punishment/updatedata'); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
								...
								<div class="form-body">									
									...
									<div class="form-group">
										...
										<div class="col-md-5 has-error">
											<input type="text" class="form-control" placeholder="Enter punishment_no No." name="punishment_no" value="<?php echo $detail->trans_no; ?>" autocomplete="off" required autofocus>				
										</div>
									</div>
									<div class="form-group">
										...
										<select class="select2_category form-control" data-placeholder="Choose Punishment Type" name="lstPunishment" required>
											...
											foreach($punishmentlist as $r) {
												if ($detail->punishment_id==$r->punishment_id) {
											?>
											<option value="<?php echo $r->punishment_id; ?>" selected><?php echo $r->punishment_name; ?></option>
											<?php } else { ?>
									...
									<div class="form-group">
										...
										<div class="col-md-9 has-error">
											<input class="form-control form-control-inline input-medium date-picker" size="16" type="text" name="date_punishment" value="<?php echo $date; ?>" placeholder="DD-MM-YYYY" autocomplete="off" required />
										</div>
									</div>
									<div class="form-group">
