...
<body class="login-body">
	<div class="container">
		<br><br><br>	
        <div align="center"><img src="<?php echo base_url(); ?>img/logo.png"></div>        
		<form class="form-signin" action="<?php echo site_url('login/validasi'); ?>" name="login" method="post">
        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
        
        	<h2 class="form-signin-heading">Masukkan User dan Password Anda :</h2>                                   
        	<div class="login-wrap">            
                <input id="username" type="text" class="form-control" name="username" value="<?php echo set_value('username'); ?>" pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{1,20}$" title='Jangan Gunakan SPASI' placeholder="Username Anda" autofocus required>
